 ...
 */
public class CatShellCommand extends Command implements ShellCommand {
	...
	public CatShellCommand() {
		super("cat");
		getDescription().add("Opens given file and writes its contents to console.");
		getDescription().add("The first argument is path to some file and is mandatory.");
		getDescription().add("The second argument is charset name that should be used to"
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		try {
			...
			throw new ShellIOException("There was an error reading from given file!");
		}
