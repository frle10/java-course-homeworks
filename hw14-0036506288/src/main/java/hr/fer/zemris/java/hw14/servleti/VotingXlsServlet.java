 ...
 */
@WebServlet(name="votingXls", urlPatterns= {"/servleti/glasanje-xls"})
public class VotingXlsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		bandNameCell.setCellValue("Option");
		...
		for(PollOptionsEntry entry : pollOptions) {
			...
			bandName.setCellValue(entry.getOptionTitle());
			votes.setCellValue(entry.getVotesCount());
		}
