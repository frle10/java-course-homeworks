...
/**
 * This is the first demo of SmartScript execution using the
 * {@link SmartScriptEngine}.
 * <p>
 * The script executed is "osnovni.smscr".
 * 
 * @author Ivan Skorupan
 */
public class ScriptExecutionDemo1 {
	...
	public static void main(String[] args) {
		...
		try {
			documentBody = Files.readString(Paths.get("webroot/scripts/osnovni.smscr"));
		} catch (IOException e) {
