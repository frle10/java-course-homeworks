...
/**
 * An implementation of {@link BiFunction} that can multiply two numbers
 * and return the result of multiplication.
 * <p>
 * What's special about it is that this strategy can multiply two arguments of type
 * {@link Object} because it is aware of the rules described in documentation
 * of {@link ValueWrapper}.
 * 
 * @author Ivan Skorupan
 */
public class MultiplicationStrategy implements BiFunction<Object, Object, Object> {
