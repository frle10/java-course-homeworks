 ...
 */
public class LsShellCommand extends Command {
	...
	public LsShellCommand() {
		super("ls");
		addDescription("Writes a directory listing (not recursive).");
		addDescription("Takes a single argument - directory.");
	}
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		try {
			...
			env.writeln("There was an error while listing the files in given directory!");
			return ShellStatus.CONTINUE;
		}
