 ...
 */
public class CharsetsShellCommand extends Command {
	...
	public CharsetsShellCommand() {
		super("charsets");
		addDescription("Takes no arguments and lists names of supported charsets for your Java platform.");
		addDescription("A single charset name is written per line.");
	}
